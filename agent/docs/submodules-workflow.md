...
```bash
git add backend/gateway/sellgar.admin.gateway backend/service/sellgar.identity.service backend/service/sellgar.product.service backend/service/sellgar.store.service backend/service/sellgar.shop.service backend/service/sellgar.file.service backend/service/sellgar.media.service frontend/sellgar.ui.admin frontend/sellgar.ui.kit frontend/sellgar.ui.desktop mobile/sellgar.mobile
